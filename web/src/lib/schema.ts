...
/** Texts of the personal account (/account/, api/internal/clients; design v3). */
const accountSchema = z.strictObject({
  ...
  login: z.strictObject({
    ...
    email_hint: localized,
    send: localized,
    no_account: localized,
    note: localized,
    telegram_title: localized,
    telegram_text: localized,
    telegram_open: localized,
    telegram_open_named: localized,
    by_email: localized,
    code_email: localized,
    code_telegram: localized,
  ...
  home: z.strictObject({
    ...
    discount: localized,
    requests: localized,
    new_answer: localized,
    last_answer: localized,
    no_answers: localized,
    ordered: localized,
    latest: localized,
    all: localized,
    ask_title: localized,
    ask_text: localized,
    by_telegram: localized,
    by_email: localized,
    ask: localized,
    eggs: localized,
    eggs_hint: localized,
    eggs_ready: localized,
    eggs_used: localized,
    project: localized,
    project_discount: localized,
    project_plain: localized,
  }),
  ...
  // A change of status in the conversation, as one sentence.
  ...
  // The same, short enough for a row of the list of requests.
  statuses_short: z.strictObject({
    new: localized,
    in_progress: localized,
    waiting_client: localized,
    done: localized,
  ...
  inquiry: z.strictObject({
    ...
    none: localized,
    subject: localized,
    subject_placeholder: localized,
    text: localized,
    text_placeholder: localized,
    send: localized,
    sent: localized,
    how: localized,
    step_number: localized,
    step_answer: localized,
    step_parent: localized,
  }),
